...
function _global_DegreeToRadians(d) {
    return d * 0.0174532925199432957;
}

//Rotate a sprite
//rotationInfo: { translationX, translationY, rotationAngle, centerX, centerY }
//spriteInfo: { sprite, x, y, w, h }
function _global_RotateSprite(context, rotationInfo, spriteInfo) {
	context.save();
		context.translate(rotationInfo.translationX, rotationInfo.translationY);
		context.rotate(_global_DegreeToRadians(rotationInfo.rotationAngle));
		context.translate(rotationInfo.centerX, rotationInfo.centerY);
		context.drawImage(spriteInfo.sprite, spriteInfo.x, spriteInfo.y, spriteInfo.w, spriteInfo.h);
	context.restore();
}
